          ...
          {siteConfig.pricing.pricingItems.map((tier) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2 p-4">
                <button
                  className={`h-11 w-full flex items-center justify-center text-sm font-normal tracking-wide rounded-full px-5 cursor-pointer transition-all ease-out active:scale-95 whitespace-nowrap ${
                    tier.isPopular
